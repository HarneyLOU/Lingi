        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Word1 = table.Column<string>(nullable: false),
                    Word2 = table.Column<string>(nullable: false),
                    Example1 = table.Column<string>(nullable: true),
                    Example2 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppFlashcards", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppTests_AppTypes_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "AppTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppTests_AppLanguages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "AppLanguages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppTests_AppLevels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "AppLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppTests_AppUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppTests_CategoryId",
                table: "AppTests",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTests_LanguageId",
                table: "AppTests",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTests_LevelId",
                table: "AppTests",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTests_UserId",
                table: "AppTests",
                column: "UserId");
